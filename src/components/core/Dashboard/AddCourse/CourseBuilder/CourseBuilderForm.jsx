...
export default function CourseBuilderForm() {
  ...
  return (
    <div className="space-y-8 rounded-lg border border-richblack-700 bg-richblack-800 p-6">
      ...
      <div className="flex justify-end gap-x-3">
        <button
          onClick={goBack}
          className="flex cursor-pointer items-center gap-x-2 rounded-md bg-richblack-300 py-2 px-5 font-semibold text-richblack-900 hover:bg-richblack-400"
        >
          Back
        </button>
